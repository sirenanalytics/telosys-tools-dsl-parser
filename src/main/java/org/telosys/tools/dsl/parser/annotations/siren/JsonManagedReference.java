 ...
 *
 */
public class JsonManagedReference extends AnnotationDefinition {

	public JsonManagedReference() {
		super(SirenParams.JsonManagedReference, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE, AnnotationScope.LINK);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.JsonManagedReference, SirenParams.Exists, true);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelLink link, Object paramValue) throws ParamError {
		...
		link.setSirenParam(SirenParams.JsonManagedReference, SirenParams.Exists, true);
	}
