 ...
 *
 */
public class NoNullsAnnotation extends AnnotationDefinition {

	public NoNullsAnnotation() {
		super("NoNulls"/*AnnotationName.CASCADE*/, AnnotationParamType.STRING, AnnotationScope.ATTRIBUTE);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.NoNulls, SirenParams.Exists, true);
		attribute.setSirenParam(SirenParams.NoNulls, SirenParams.Message, paramValue);
	}
