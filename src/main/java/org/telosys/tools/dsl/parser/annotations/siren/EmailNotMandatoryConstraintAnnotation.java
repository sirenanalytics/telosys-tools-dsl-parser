 ...
 *
 */
public class EmailNotMandatoryConstraintAnnotation extends AnnotationDefinition {

	public EmailNotMandatoryConstraintAnnotation() {
		super(SirenParams.EmailNotMandatoryConstraint, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.EmailNotMandatoryConstraint, SirenParams.Exists, true);
	}
