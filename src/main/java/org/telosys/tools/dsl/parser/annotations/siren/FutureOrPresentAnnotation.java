 ...
 *
 */
public class FutureOrPresentAnnotation extends AnnotationDefinition {

	public FutureOrPresentAnnotation() {
		super(SirenParams.FutureOrPresent/*AnnotationName.CASCADE*/, AnnotationParamType.STRING, AnnotationScope.ATTRIBUTE);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.FutureOrPresent, SirenParams.Exists, true);
		attribute.setSirenParam(SirenParams.FutureOrPresent, SirenParams.Message, paramValue);
	}
