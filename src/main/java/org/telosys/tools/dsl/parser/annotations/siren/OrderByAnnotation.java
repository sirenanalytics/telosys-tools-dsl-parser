 ...
 *
 */
public class OrderByAnnotation extends AnnotationDefinition {

	public OrderByAnnotation() {
		super(SirenParams.OrderBy, AnnotationParamType.STRING, AnnotationScope.LINK);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelLink link, Object paramValue) throws ParamError {
		...
		link.setSirenParam(SirenParams.OrderBy, SirenParams.Exists, true);
		link.setSirenParam(SirenParams.OrderBy, SirenParams.Expression, paramValue);
	}
