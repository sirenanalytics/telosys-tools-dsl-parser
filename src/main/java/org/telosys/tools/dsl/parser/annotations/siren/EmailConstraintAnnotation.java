 ...
 *
 */
public class EmailConstraintAnnotation extends AnnotationDefinition {

	public EmailConstraintAnnotation() {
		super(SirenParams.EmailConstraint, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.EmailConstraint, SirenParams.Exists, true);
	}
