 ...
 *
 */
public class LebaneseMobileConstraintAnnotation extends AnnotationDefinition {

	public LebaneseMobileConstraintAnnotation() {
		super(SirenParams.LebaneseMobileConstraint, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.LebaneseMobileConstraint, SirenParams.Exists, true);
	}
