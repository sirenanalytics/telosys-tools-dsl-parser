 ...
 *
 */
public class MinSizeAnnotation extends AnnotationDefinition {

	public MinSizeAnnotation() {
		super(SirenParams.MinSize, AnnotationParamType.LIST, AnnotationScope.ATTRIBUTE);
	}
	...
	public void afterCreation(String entityName, String fieldName, DomainAnnotation annotation) throws ParamError {
		...
		if ( list == null || list.size() < 1) {
			throw new ParamError("at least 1 parameters required Min");
		} 
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.MinSize, SirenParams.Exists, true);
		attribute.setSirenParam(SirenParams.MinSize, SirenParams.Min, list.get(0));
		if (list.size() > 1) {
			attribute.setSirenParam(SirenParams.MinMaxSize, SirenParams.Message, list.get(1));
		}
	}
