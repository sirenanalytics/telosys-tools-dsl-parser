 ...
 *
 */
public class NoBlanksAnnotation extends AnnotationDefinition {

	public NoBlanksAnnotation() {
		super("NoBlanks"/*AnnotationName.CASCADE*/, AnnotationParamType.STRING, AnnotationScope.ATTRIBUTE);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.NoBlanks, SirenParams.Exists, true);
		attribute.setSirenParam(SirenParams.NoBlanks, SirenParams.Message, paramValue);
	}
