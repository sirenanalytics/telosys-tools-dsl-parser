 ...
 *
 */
public class NotNullKeyAnnotation extends AnnotationDefinition {

	public NotNullKeyAnnotation() {
		super(SirenParams.KeyNotNull, AnnotationParamType.STRING, AnnotationScope.LINK);
	}
...
//		} 
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelLink link, Object paramValue) throws ParamError {
		...
		link.setSirenParam(SirenParams.KeyNotNull, SirenParams.Exists, true);
		link.setSirenParam(SirenParams.KeyNotNull, SirenParams.Message, paramValue);
	}
