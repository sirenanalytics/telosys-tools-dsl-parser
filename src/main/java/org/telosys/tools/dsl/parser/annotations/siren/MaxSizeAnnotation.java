 ...
 *
 */
public class MaxSizeAnnotation extends AnnotationDefinition {

	public MaxSizeAnnotation() {
		super(SirenParams.MaxSize, AnnotationParamType.LIST, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute, Object paramValue) throws ParamError {
		...
		attribute.setSirenParam(SirenParams.MaxSize, SirenParams.Exists, true);
		attribute.setSirenParam(SirenParams.MaxSize, SirenParams.Max, list.get(0));
		if (list.size() > 1) {
